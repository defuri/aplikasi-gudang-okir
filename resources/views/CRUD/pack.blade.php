                    ...
                    <form action="{{ route('pack.store') }}" method="POST">
                        ...
                        <div class="grid gap-4 mb-4 sm:grid-cols-1">
                            ...
                            <div>
                                ...
                                <input type="number" name="ukuran" id="ukuran" min="1"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            ...
                            <div>
                                ...
                                <select id="id_satuan" name="id_satuan" required
                                    ...
                                    @foreach ($satuan as $dataSatuan)
                                        <option value="{{ $dataSatuan->id }}">{{ $dataSatuan->nama }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                            ...
                            <tbody>
                                @foreach ($pack as $data)
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-3">{{ $data->ukuran }}</td>
                                    ...
                                    <div id="updateProductModal{{ $loop->iteration }}" tabindex="-1"
                                        ...
                                        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                                            ...
                                            <div
                                                ...
                                                <form action="{{ route('pack.update', $data->id) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="grid gap-4 mb-4 sm:grid-cols-1">
                                                        <div>
                                                            ...
                                                            <input type="text" name="nama" id="name"
                                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                                placeholder="Masukan nama" value="{{ $data->nama }}" required="" required>
                                                        </div>
                                                        <div>
                                                            <label for="ukuran"
                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Ukuran</label>
                                                            <input type="number" name="ukuran" id="ukuran" value="{{ $data->ukuran }}"
                                                                min="1"
                                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                                placeholder="Masukan ukuran" required=""
                                                                oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                                        ...
                                                        <div>
                                                            ...
                                                            <select id="id_satuan" name="id_satuan" required
                                                                ...
                                                                @foreach ($satuan as $data_satuan)
                                                                    <option value="{{ $data_satuan->id }}"
                                                                        @if ($data_satuan->id == $data->id_satuan) selected @endif>
                                                                        {{ $data_satuan->nama }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                        ...
                                        <div class="relative p-4 w-full max-w-md max-h-full">
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div class="p-4 md:p-5 text-center">
                                                    ...
                                                    <form action="{{ route('pack.destroy', $data->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
                    ...
                    <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4"
                        ...
                        <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                            ...
                            dari
                            <span class="font-semibold text-gray-900 dark:text-white">{{ $pack->total() }}</span>
                        </span>
