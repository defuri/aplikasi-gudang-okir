        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    ...
                    <tbody>
                        @forelse ($akun as $data)
                                            ...
                                            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                                ...
                                                <div>
                                                    <label for="id_hak"
                                                        ...
                                                        hak akses:</label>
                                                    <select id="id_hak" name="id_hak" required
                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                        <option value="" disabled selected>Pilih hak
                                                        </option>
                                                        @foreach ($hak as $data_hak)
                                                            <option value="{{ $data_hak->id }}">{{ $data_hak->nama }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                    ...
                                    <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                        ...
                                        <form action="{{ route('akun.update', $data->id) }}" method="POST">
                                                ...
                                                <div>
                                                    ...
                                                    <select id="id_hak" name="id_hak" required
                                                        ...
                                                        @foreach ($hak as $dataHak)
                                                            <option value="{{ $dataHak->id }}"
                                                                @if ($dataHak->id == $data->id_hak) selected @endif>
                                                                {{ $dataHak->nama }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="flex items-center space-x-4">
                                                <button type="submit"
                                                    class="text-gray-900 dark:text-gray-400 bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                                                    Perbarui divisi
                                                </button>
                                            </div>
                                        </form>
                            ...
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3">{{ Str::limit($data->password, 13, '...') }}</td>
            ...
            <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4"
                ...
                <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                    ...
                    dari
                    <span class="font-semibold text-gray-900 dark:text-white">{{ $akun->total() }}</span>
                </span>
