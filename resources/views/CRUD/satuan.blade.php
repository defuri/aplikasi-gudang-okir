...
@section('content')
    ...
    <div
        class="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-800 relative shadow-sm sm:rounded-lg overflow-hidden">
        ...
        <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
            <div class="w-full md:w-1/2">
                <form class="flex items-center focus-within:ring-1 focus-within:ring-blue-700 rounded-lg"
                    ...
                    <div class="relative w-full">
                        ...
                        <input type="text" value="satuan" name="tabel" id="" required class="hidden">
            ...
            <div
                ...
                <button type="button" data-modal-target="defaultModal" data-modal-toggle="defaultModal"
                    class="flex items-center border-2 border-gray-300 dark:border-gray-600 justify-center text-gray-900 dark:text-gray-300 bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
        ...
        <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4"
            ...
            <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                ...
                dari
                <span class="font-semibold text-gray-900 dark:text-white">{{ count($dataSatuan) }}</span>
            </span>
