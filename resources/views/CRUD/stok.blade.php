                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <form action="{{ route('stok.store') }}" method="POST">
                        ...
                        <div class="grid gap-4 mb-4 sm:grid-cols-2">
                            ...
                            <div>
                                <label for="id_gudang"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pilih gudang:</label>
                                <select id="id_gudang" name="id_gudang" required
                                    ...
                                    @foreach ($gudang as $data_gudang)
                                        <option value="{{ $data_gudang->id }}">{{ $data_gudang->nama }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            <div>
                                ...
                                <select id="id_produk" name="id_produk" required
                                    ...
                                    @foreach ($produk as $data_produk)
                                        <option value="{{ $data_produk->id }}">{{ $data_produk->nama }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                                        ...
                                        <div class="relative p-4 w-full max-w-md max-h-full">
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div class="p-4 md:p-5 text-center">
                                                    ...
                                                    <form action="{{ route('stok.destroy', $data->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
