            ...
            <div id="defaultModal" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                    ...
                    <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                        ...
                        <!-- Modal body -->
                        <form action="{{ route('ProdukMasuk.create') }}" method="GET">
                ...
                <div class="w-full md:w-1/2">
                    <form class="flex items-center focus-within:ring-1 focus-within:ring-blue-700 rounded-lg"
                        ...
                        <div class="relative w-full">
                            ...
                            <input type="text" value="produkMasuk" name="tabel" id="" required class="hidden">
                            ...
                            <div id="updateProductModal{{ $loop->iteration }}" tabindex="-1" aria-hidden="true"
                                ...
                                <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                                    ...
                                    <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                        ...
                                        <form action="{{ route('ProdukMasuk.update', $data->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                ...
                                <div class="relative p-4 w-full max-w-md max-h-full">
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-4 md:p-5 text-center">
                                            ...
                                            <form action="{{ route('ProdukMasuk.destroy', $data->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
