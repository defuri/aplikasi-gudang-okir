    ...
    <div
        ...
        <div id="defaultModal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <!-- Modal body -->
                    <form action="{{ route('produk-keluar.create') }}" method="GET">
        ...
        <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
            <div class="w-full lg:w-1/2">
                <form class="flex items-center focus-within:ring-1 focus-within:ring-blue-700 rounded-lg" method="GET"
                    action="{{ route('search') }}">
                    @csrf
                    ...
                    <div class="relative w-full">
                        ...
                        <input type="text" value="produkKeluar" name="tabel" id="" required
                            class="hidden">
                        <input datepicker datepicker-autohide type="text" name="tanggal" value="{{ $inputan ?? '' }}"
                            ...
                            <div class="relative p-4 w-full max-w-md max-h-full">
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div class="p-4 md:p-5 text-center">
                                        ...
                                        <form action="{{ route('produk-keluar.destroy', $data->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button data-modal-hide="popup-modal{{ $loop->iteration }}" type="submit"
