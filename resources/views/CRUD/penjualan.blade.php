        ...
        <div id="modalCetak" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <!-- Modal body -->
                    <form action="/cetakPenjualan" method="POST" class="p-4 md:p-5">
                        @csrf
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            <div class="col-span-1">
                                <label for="cetakTanggal"
                            ...
                            <div>
                                ...
                                <select id="id_produk" name="id_produk" required
                                    ...
                                    @foreach ($produk as $dataProduk)
                                        <option value="{{ $dataProduk->id }}">{{ $dataProduk->nama }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="w-full lg:w-1/2">
                            <form class="flex items-center focus-within:ring-1 focus-within:ring-blue-700 rounded-lg"
                                ...
                                <div class="relative w-full">
                                    ...
                                    <input type="text" id="simple-search" name="cari"
                                        value="{{ $query ?? '' }}"
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-3">omzet</th>
                            ...
                            <tbody>
                                @foreach ($penjualan as $data)
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-3">{{ $data->omzet }}</td>
                                                    ...
                                                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <input type="number" name="jumlah" id="jumlah"
                                                                ...
                                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                                placeholder="Masukan stok" required="" required
                                                                oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                                        </div>
                                                    </div>
