        ...
        <div
                ...
                <div class="w-full lg:w-1/2">
                    <form class="flex items-center focus-within:ring-1 focus-within:ring-blue-700 rounded-lg"
                        ...
                        <div class="relative w-full">
                            ...
                            <input type="text" value="penjualan" name="tabel" id="" required
                                class="hidden">
                                    ...
                                    <div
                                        ...
                                        <div class="flex justify-between mb-4 rounded-t sm:mb-5">
                                            <div class="text-lg text-gray-900 md:text-xl dark:text-white">
                                                <h3 class="font-semibold text-xl">No referensi: {{ $data->id }}
                                                </h3>
                                            ...
                                            <div class="overflow-x-auto">
                                                <div class="inline-block min-w-[500px] align-middle">
                                                    <div class="overflow-hidden">
                                                        <!-- Header Table -->
                                                        <div
                                                            class="grid grid-cols-3 mb-3 text-xs capitalize text-gray-700 bg-slate-50 dark:bg-gray-700 dark:text-gray-400 py-3">
                                                            <p class="font-bold pl-4">Produk</p>
                                                        ...
                                                        <div class="overflow-y-auto max-h-[50vh]">
                                                            <div class="flex flex-col space-y-2 text-sm">
                                                                @foreach ($data->detailPenjualan as $currentDetail)
                                                                    <div
                                                                        class="grid grid-cols-3 border-b border-gray-200 dark:border-gray-700 pb-2">
                                                                        <p
                                        ...
                                        <div class="flex justify-between items-center mt-3">
                                            <div class="flex items-center space-x-3">
                                                ...
                                                <form action="{{ route('penjualan.edit', $data->id) }}"
                                                    method="GET">
                                                    <button type="submit"
            ...
            <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4"
                ...
                <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                    Menampilkan
                    <span class="font-semibold text-gray-900 dark:text-white">1-{{ $penjualan->perPage() }}</span>
                    dari
                    <span class="font-semibold text-gray-900 dark:text-white">{{ $penjualan->total() }}</span>
                </span>
