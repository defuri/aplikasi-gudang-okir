                    ...
                    <form action="{{ route('jabatan.store') }}" method="POST">
                        ...
                        <div class="grid gap-4 mb-4 sm:grid-cols-1">
                            ...
                            <div>
                                ...
                                <input type="number" name="gaji" id="gaji" min="1"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Masukan gaji" required=""
                ...
                <div
                        ...
                        <div class="w-full md:w-1/2">
                            <form class="flex items-center focus-within:ring-1 focus-within:ring-blue-700 rounded-lg"
                                ...
                                <div class="relative w-full">
                                    ...
                                    <input type="text" value="jabatan" name="tabel" id="" required
                                        class="hidden">
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-3">gaji</th>
                            ...
                            <tbody>
                                @foreach ($jabatan as $data)
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-3">{{ $data->gaji }}</td>
                    ...
                    <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4"
                        ...
                        <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                            ...
                            dari
                            <span class="font-semibold text-gray-900 dark:text-white">{{ $jabatan->total() }}</span>
                        </span>
