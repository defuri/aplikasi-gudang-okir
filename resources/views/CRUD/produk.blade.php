                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <form action="{{ route('produk.store') }}" method="POST">
                        ...
                        <div class="grid gap-4 mb-4 sm:grid-cols-2">
                            ...
                            <div>
                                <label for="rasa"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Rasa</label>
                                <select id="rasa" name="id_rasa" required
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option value="" disabled selected>Pilih rasa
                                    </option>
                                    @foreach ($rasa as $dataRasa)
                                        <option value="{{ $dataRasa->id }}">{{ $dataRasa->nama }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            <div>
                                ...
                                <select id="kategori" name="id_kategori" required
                                    ...
                                    @foreach ($kategori as $dataKategori)
                                        <option value="{{ $dataKategori->id }}">{{ $dataKategori->nama }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            <div>
                                <label for="pack"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pack</label>
                                <select id="pack" name="id_pack" required
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option value="" disabled selected>Pilih pack
                                    </option>
                                    @foreach ($pack as $dataPack)
                                        <option value="{{ $dataPack->id }}">{{ $dataPack->nama }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-3">rasa</th>
                                    <th scope="col" class="px-4 py-3">kategori</th>
                                    <th scope="col" class="px-4 py-3">pack</th>
                            ...
                            <tbody>
                                @foreach ($produk as $data)
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-3">{{ $data->rasa->nama }}</td>
                                        <td class="px-4 py-3">{{ $data->kategori->nama }}</td>
                                        <td class="px-4 py-3">{{ $data->pack->nama }}</td>
                                    ...
                                    <div id="updateProductModal{{ $loop->iteration }}" tabindex="-1"
                                        ...
                                        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                                            ...
                                            <div
                                                ...
                                                <form action="{{ route('produk.update', $data->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                                        ...
                                                        <div>
                                                            <label for="rasa"
                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pilih rasa:</label>
                                                            <select id="rasa" name="id_rasa" required
                                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                                @foreach ($rasa as $data_rasa)
                                                                    <option value="{{ $data_rasa->id }}"
                                                                        @if ($data_rasa->id == $data->id_rasa) selected @endif>
                                                                        {{ $data_rasa->nama }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div>
                                                            <label for="kategori"
                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pilih kategori:</label>
                                                            <select id="kategori" name="id_kategori" required
                                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                                @foreach ($kategori as $data_kategori)
                                                                    <option value="{{ $data_kategori->id }}"
                                                                        @if ($data_kategori->id == $data->id_kategori) selected @endif>
                                                                        {{ $data_kategori->nama }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div>
                                                            <label for="pack"
                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pilih pack:</label>
                                                            <select id="pack" name="id_pack" required
                                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                                @foreach ($pack as $data_pack)
                                                                    <option value="{{ $data_pack->id }}"
                                                                        @if ($data_pack->id == $data->id_pack) selected @endif>
                                                                        {{ $data_pack->nama }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
