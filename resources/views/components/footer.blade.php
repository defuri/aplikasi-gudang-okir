<footer
    class="bg-white rounded-lg shadow border border-gray-200 dark:border-gray-700 sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800 antialiased mt-6">
