<footer
    class="mb-6 bg-white rounded-lg shadow border border-gray-300 dark:border-gray-700 sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800 antialiased mt-6">
    <p class="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
        &copy; 2024 <a href="https://flowbite.com/" class="hover:underline" target="_blank">PT Original Kiripik</a>. Hak
        cipta dilindungi.
    </p>
